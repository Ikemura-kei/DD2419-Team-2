...
class ObjApproachPointReached(TemplateBehavior):
    def __init__(self, name="obj_approach_point_reached"):
        super().__init__(name)
        
        self.register_value('obj_approach_pnt', read=True, write=False)
    ...
    def update(self):
        try:
            obj_approach_pnt = self.blackboard.get('obj_approach_pnt')
        except:
            return py_trees.common.Status.FAILURE
        
        pose_map:PoseStamped = obj_approach_pnt
        try:
